...
function momoMarkKeywordMsg()
{
	...
	if(isset($mmkKeyword))
	{
		...
		$mmkMsg = $mmkMsg . '<span class="wmkPowerBy">Power by: <a href ="http://conis.cn" target="_blank">conis.cn</a></span></fieldset>';
		return $mmkMsg;
	}	
	return '';
}
...
{		
	...
	if(isset($mmkKeyword))
	{
		...
		foreach($arrKeyword as $item)
		{
			$content = str_ireplace( $item, '<span class="wmkHighLight">'.$item.'</span>', $content);	
		}
	}
	$mmkIsShowMsg = true;
